...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawHerohand(handString, dx) {
        ...
        // Draw rank
        ctx.fillText(rank, 240 + dx + 36 / 2, 340 + 50 / 3);

        // Draw suit
        ctx.fillText(suitsSymbols[suit], 240 + dx + 36 / 2, 340 + (2 * 50) / 3);
    ...
    function drawTable(positions, invested, holdingCards, board) {
        ...
        ctx.beginPath();
        ctx.ellipse(280, 230, 280, 180, 0, 0, Math.PI * 2);
