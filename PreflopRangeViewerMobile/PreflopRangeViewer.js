...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const canvas1 = document.getElementById('rangeCanvas1');
    const canvas2 = document.getElementById('rangeCanvas2');
    const canvas3 = document.getElementById('rangeCanvas3');
    const canvas4 = document.getElementById('rangeCanvas4');
    const canvas5 = document.getElementById('rangeCanvas5');


    const RFI_button = document.getElementById('RFI_button');
    const BBDEF_button = document.getElementById('BBDEF_button');
    const SBDEF_button = document.getElementById('SBDEF_button');
    const IP3BetvsUTG_button = document.getElementById('IP3BetvsUTG_button');
    const IP3BetvsHJ_button = document.getElementById('IP3BetvsHJ_button');
